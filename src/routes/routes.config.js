...
export const ROUTE_NAMES = {
    ...
    // Rate Cards
    RATECARDS_LIST: 'ratecards-list',
    RATECARD_BUILDER: 'ratecard-builder',
  ...
  // ============================================
  // Features (for feature-based access control)
  // ============================================
  ...
  export const ROUTE_CONFIG = {
    ...
    [ROUTE_NAMES.RATECARD_BUILDER]: {
      ...
      description: 'Create custom rate cards',
      parent: ROUTE_NAMES.RATECARDS_LIST,
      requiredAuth: true
    },
    
    [ROUTE_NAMES.RATECARD_EDIT]: {
      path: '/ratecards/:rateCardId/edit',
      title: 'Edit Rate Card',
      description: 'Modify rate card',
      parent: ROUTE_NAMES.RATECARDS_LIST,
      requiredAuth: true
    },
