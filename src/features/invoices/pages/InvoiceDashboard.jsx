        ...
        <div style={styles.header}>
          ...
          <div style={styles.statsGrid}>
            <div style={styles.statCard}>
              ...
              <div style={styles.statContent}>
                ...
                <div style={styles.statValue}>
                  {dashboard?.monthlyAnalytics?.totalInvoices || 0}
                </div>
                <div style={{
                  ...styles.statChange,
                  color: '#10b981'
            ...
            <div style={styles.statCard}>
              <div style={{
                ...styles.statIcon,
                backgroundColor: dashboard?.overdueInvoices > 0
                  ? 'rgba(239, 68, 68, 0.1)'
                  : 'rgba(34, 197, 94, 0.1)'
              }}>
                <AlertTriangle size={22} color={dashboard?.overdueInvoices > 0 ? "#ef4444" : "#22c55e"} />
              </div>
              <div style={styles.statContent}>
                    ...
                    <div style={styles.invoiceBody}>
                      <div style={styles.invoiceField}>
                        ...
                        <span style={{
                          ...
                          {formatCurrency(invoice.amount || invoice.taxSettings?.taxCalculation?.finalAmount || 0)}
                        </span>
                      </div>
