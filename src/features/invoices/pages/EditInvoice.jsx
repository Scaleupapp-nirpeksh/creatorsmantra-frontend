...
const EditInvoice = () => {
  ...
  const { currentInvoice, fetchInvoiceById, updateInvoice, calculateTaxPreview } = useInvoiceStore()
  ...
  const addLineItem = () => {
    setFormData((prev) => ({
      ...
      lineItems: [
        ...
        {
          // TEMP
          // REASON: Requires ObjectId generated at backend
          // id: `item-${Date.now()}`,
          description: '',
          quantity: 1,
          rate: 0,
        ...
        <div style={styles.grid}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
            <div style={styles.warningBox}>
              ...
              <div>
                <strong>Note:</strong> Only draft invoices can be edited. Once sent, the invoice
                becomes read-only.
              </div>
            </div>
            ...
            <div style={styles.card}>
              ...
              <div style={styles.cardContent}>
                <textarea
                  ...
                  onChange={(e) =>
                    setFormData((prev) => ({ ...prev, revisionNotes: e.target.value }))
                  }
