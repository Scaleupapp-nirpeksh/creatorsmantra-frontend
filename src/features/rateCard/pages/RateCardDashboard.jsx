                      ...
                      {['all', 'draft', 'active', 'archived'].map((status) => (
                        <button
                          ...
                          style={{
                            ...
                            gap: 'var(--space-2)',
                            backgroundColor:
                              statusFilter === status ? 'var(--color-primary-50)' : 'transparent',
                            color:
                              statusFilter === status
              ...
              <div style={{ maxWidth: '28rem', margin: '0 auto' }}>
                <div
                  style={{
                    ...
                    background:
                      'linear-gradient(to bottom right, var(--color-primary-100), var(--color-secondary-100))',
                    borderRadius: '50%',
                    display: 'flex',
                    alignItems: 'center',
                      ...
                      <div style={{ padding: 'var(--space-6)' }}>
                        ...
                        >
                          ...
                          <div style={{ position: 'relative' }}>
                            <button
                              onClick={() =>
                                setActiveDropdown(activeDropdown === card._id ? null : card._id)
                              }
                              style={{
                                padding: 'var(--space-2)',
                                borderRadius: 'var(--radius-lg)',
                      ...
                      return (
                        <button
                          ...
                          style={{
                            ...
                            backgroundColor:
                              currentPage === page ? 'var(--color-primary-600)' : 'white',
