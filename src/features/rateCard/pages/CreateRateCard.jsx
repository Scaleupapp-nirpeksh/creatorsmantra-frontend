  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (result && onNavigate) {
        onNavigate(`/dashboard/rate-cards/${result.rateCard._id}`)
      }
    } catch (error) {
  ...
  return (
    <div
      style={{
        minHeight: '100vh',
        background:
          'linear-gradient(to bottom right, var(--color-primary-50), var(--color-secondary-50), var(--color-accent-50))',
      }}
    >
      {/* Header */}
      <div
                ...
                {index < steps.length - 1 && (
                  <div
                    style={{
                      ...
                      backgroundColor:
                        currentStep > step.id ? 'var(--color-success)' : 'var(--color-neutral-200)',
                      marginTop: '-1.5rem',
                    }}
                  />
                )}
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-6)' }}>
                ...
                <div>
                  ...
                  <input
                    ...
                    onBlur={(e) => {
                      e.target.style.borderColor = validationErrors.title
                        ? 'var(--color-error)'
                        : 'var(--color-border)'
          ...
          {currentStep === 2 && (
            ...
            >
              <div style={{ marginBottom: 'var(--space-8)' }}>
                ...
                <p style={{ color: 'var(--color-text-secondary)' }}>
                  Add your social media platforms and current metrics to generate accurate pricing
                  suggestions.
                </p>
              </div>
                      ...
                      >
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              updatePlatformMetric(index, 'engagementRate', e.target.value)
                            }
                            placeholder="3.5"
                            min="0"
                            max="100"
                    ...
                    {niches.map((niche) => (
                      <button
                        ...
                        style={{
                          ...
                          borderRadius: 'var(--radius-lg)',
                          backgroundColor:
                            formData.metrics.niche === niche ? 'var(--color-primary-50)' : 'white',
                          color:
                            formData.metrics.niche === niche
                      ...
                      {cityTiers.map((tier) => (
                        <button
                          ...
                          style={{
                            ...
                            borderRadius: 'var(--radius-lg)',
                            backgroundColor:
                              formData.metrics.location.cityTier === tier.value
                    ...
                    {languages.map((language) => (
                      <button
                        ...
                        style={{
                          ...
                          borderRadius: 'var(--radius-lg)',
                          backgroundColor: formData.metrics.languages.includes(language)
                            ? 'var(--color-primary-50)'
                            : 'white',
                          color: formData.metrics.languages.includes(language)
                            ? 'var(--color-primary-700)'
                            : 'var(--color-text)',
                          fontWeight: formData.metrics.languages.includes(language)
                            ? 'var(--font-semibold)'
                            : 'var(--font-normal)',
                          cursor: 'pointer',
                          transition: 'all var(--duration-200) ease',
                    ...
                    {experienceLevels.map((level) => (
                      <button
                        ...
                        style={{
                          ...
                          borderRadius: 'var(--radius-lg)',
                          backgroundColor:
                            formData.metrics.experience === level.value
                              ? 'var(--color-primary-50)'
                              : 'white',
                          color:
                            formData.metrics.experience === level.value
          ...
          {currentStep === 4 && (
            ...
            >
              <div style={{ marginBottom: 'var(--space-8)' }}>
                ...
                <p style={{ color: 'var(--color-text-secondary)' }}>
                  Review your information before creating your rate card. AI pricing suggestions
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-8)' }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-3)' }}>
                    ...
                    {formData.description && (
                      <div>
                        ...
                        <div style={{ color: 'var(--color-text)' }}>{formData.description}</div>
                      </div>
                    )}
                  </div>
                </div>
                        ...
                        >
                          ...
                          <div style={{ flex: 1 }}>
                            ...
                            >
                              ...
                              {platform.metrics.engagementRate}% engagement
                              {platform.metrics.avgViews &&
                                ` • ${formatNumber(platform.metrics.avgViews)} avg views`}
                            </div>
                          </div>
                        </div>
                      )
                ...
                >
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div style={{ fontWeight: 'var(--font-medium)', color: 'var(--color-text)' }}>
                        {
                          experienceLevels.find((l) => l.value === formData.metrics.experience)
                            ?.label
                        }
                      </div>
                    </div>
                ...
                >
                  ...
                  <div>
                    ...
                    >
                      Based on your metrics and profile, our AI will generate personalized pricing
                      suggestions for each platform, considering current market rates, your niche,
                      and location. You'll be able to review and adjust all suggestions before
