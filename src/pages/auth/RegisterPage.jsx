...
// Constants
import { RegisterPageConstants } from '../../utils/constants'

// Styles
import { registerPageStyles as styles } from '../../utils/stylesInline'
...
const RegisterPage = () => {
  ...
  // Constants
  const { CreatorTypes: creatorTypes } = RegisterPageConstants
    ...
    <div style={styles.progressContainer}>
      ...
      <div style={styles.progressSteps}>
        {[1, 2, 3].map((step) => (
          ...
          >
            {step < currentStep ? <CheckCircle size={20} /> : <span>{step}</span>}
          </div>
        ))}
      </div>
      ...
      >
        ...
        <div style={styles.form}>
                  ...
                  <div style={styles.socialInputGroup}>
                    <div style={styles.inputGroup}>
                      ...
                      {errors.instagram_username && (
                        <span style={styles.error}>{errors.instagram_username.message}</span>
                      )}
                    </div>
                    <div style={styles.inputGroup}>
                      <input
          ...
          <div style={styles.buttonGroup}>
            {currentStep > 1 && (
              <button type="button" onClick={handlePrevStep} style={styles.backButton}>
                <ArrowLeft size={20} />
                Back
              </button>
            )}
