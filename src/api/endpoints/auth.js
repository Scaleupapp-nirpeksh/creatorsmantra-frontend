...
export const authAPI = {
  ...
  sendOTP: (phone, purpose = 'registration') => api.post('/auth/send-otp', { phone, purpose }),
  ...
  inviteManager: (email, permissions) => api.post('/auth/invite-manager', { email, permissions }),

  getSuggestedRates: () => api.get('/auth/suggested-rates'),

  checkFeatureAccess: () => api.get('/auth/feature-access'),
